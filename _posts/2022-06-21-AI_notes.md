...
{% include figure.html path="assets/markdown_assets/AI_notes/Untitled%201.png" title="AI_ML_DL" class="img-fluid rounded z-depth-1" %}
...
{% include figure.html path="assets/markdown_assets/AI_notes/Untitled%202.png" title="AI_ML_DL" class="img-fluid rounded z-depth-1" %}

### Stochastic Gradient Descent

{% include figure.html path="assets/markdown_assets/AI_notes/Untitled%203.png" title="AI_ML_DL" class="img-fluid rounded z-depth-1" %}
...
{% include figure.html path="assets/markdown_assets/AI_notes/Untitled%204.png" title="AI_ML_DL" class="img-fluid rounded z-depth-1" %}

## Overfitting & Underfitting

- Basically you have to leverage between data complexity vs model capacity
    
    {% include figure.html path="assets/markdown_assets/AI_notes/Untitled%205.png" title="AI_ML_DL" class="img-fluid rounded z-depth-1" %}
    ...
    - More features to find a better fit.
        - Altough you increase linear in the number of the feature.
            - That increases exponentially the number of data
               ...
               {% include figure.html path="assets/markdown_assets/AI_notes/Untitled%206.png" title="AI_ML_DL" class="img-fluid rounded z-depth-1" %}
...
- When a model is over fitting you can
    ...
    - Downsize the hypothesis space
        ...
        {% include figure.html path="assets/markdown_assets/AI_notes/Untitled%207.png" title="AI_ML_DL" class="img-fluid rounded z-depth-1" %}
...
{% include figure.html path="assets/markdown_assets/AI_notes/Untitled%208.png" title="AI_ML_DL" class="img-fluid rounded z-depth-1" %}
...
{% include figure.html path="assets/markdown_assets/AI_notes/Untitled%209.png" title="AI_ML_DL" class="img-fluid rounded z-depth-1" %}
...
{% include figure.html path="assets/markdown_assets/AI_notes/Untitled%2010.png" title="AI_ML_DL" class="img-fluid rounded z-depth-1" %}
...
{% include figure.html path="assets/markdown_assets/AI_notes/Untitled%2011.png" title="AI_ML_DL" class="img-fluid rounded z-depth-1" %}

- ***Boosting***
    - (K+1)th classifier tries to correct the k-th classifiers errors.
    - A kind of a chain of classifiers

{% include figure.html path="assets/markdown_assets/AI_notes/Untitled%2012.png" title="AI_ML_DL" class="img-fluid rounded z-depth-1" %}
...
{% include figure.html path="assets/markdown_assets/AI_notes/Untitled%2013.png" title="AI_ML_DL" class="img-fluid rounded z-depth-1" %}
