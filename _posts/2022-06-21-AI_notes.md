    ...
    - More features to find a better fit.
        - Altough you increase linear in the number of the feature.
            - That increases exponentially the number of data
               ...
               {% include figure.html path="assets/markdown_assets/AI_notes/Untitled6.png" title="AI_ML_DL" class="img-fluid rounded z-depth-1" %}
...
- When a model is over fitting you can
    ...
    - Downsize the hypothesis space
        ...
        {% include figure.html path="assets/markdown_assets/AI_notes/Untitled7.png" title="AI_ML_DL" class="img-fluid rounded z-depth-1" %}
